...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../src/scripts/map.js":[function(require,module,exports) {
var define;
...
window.changeMapType = function (type) {
  ...
  document.querySelectorAll('.map-type-button').forEach(function (btn) {
    btn.classList.remove('active');
  });
  document.querySelector("button[onclick=\"changeMapType('".concat(type, "')\"]")).classList.add('active');
};
...
function getQuakeRadius(magnitude, zoomLevel) {
  var baseSize = 2500;
  var magnitudeFactor;
  if (magnitude >= 7.0) magnitudeFactor = 2.5;else if (magnitude >= 6.0) magnitudeFactor = 2.0;else if (magnitude >= 5.0) magnitudeFactor = 1.5;else magnitudeFactor = 1.0;
...
function updateCircles(newZoom) {
  map.eachLayer(function (layer) {
    if (layer instanceof L.Circle) {
      ...
      var magnitudeMatch = popupContent.match(/Büyüklük:<\/strong> ([\d.]+)/);
      var magnitude = magnitudeMatch ? parseFloat(magnitudeMatch[1]) : 3.0;
      var newRadius = getQuakeRadius(magnitude, newZoom);
...
function loadCurrentEarthquakes() {
  return _loadCurrentEarthquakes.apply(this, arguments);
} // Global scope'da fonksiyonları tanımla
function _loadCurrentEarthquakes() {
  _loadCurrentEarthquakes = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, earthquakes;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return fetch('http://localhost:3000/api/earthquakes');
        case 3:
        ...
        case 6:
          ...
          earthquakes.forEach(function (quake) {
            var lat = parseFloat(quake.enlem);
            var lng = parseFloat(quake.boylam);
            ...
            circle.bindPopup("\n                <div class=\"popup-content\">\n                    <h3>Deprem Bilgileri</h3>\n                    <p><strong>B\xFCy\xFCkl\xFCk:</strong> ".concat(magnitude.toFixed(1), "</p>\n                    <p><strong>Tarih:</strong> ").concat(quake.tarih, "</p>\n                    <p><strong>Saat:</strong> ").concat(quake.saat, "</p>\n                    <p><strong>Derinlik:</strong> ").concat(quake.derinlik, " km</p>\n                    <p><strong>Yer:</strong> ").concat(quake.yer, "</p>\n                </div>\n            "));
          });
          _context.next = 14;
          break;
        case 11:
          ...
          console.error('Güncel deprem verileri yüklenirken hata:', _context.t0);
        case 14:
        case "end":
...
function loadYearEarthquakes(_x) {
  return _loadYearEarthquakes.apply(this, arguments);
} // Yıl butonları için event handler'lar
function _loadYearEarthquakes() {
  _loadYearEarthquakes = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(year) {
    var response, earthquakes, currentZoom;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return fetch("http://localhost:5000/api/earthquakes/year/".concat(year));
        case 3:
          response = _context2.sent;
          _context2.next = 6;
          return response.json();
        case 6:
          earthquakes = _context2.sent;
          ...
          earthquakes.forEach(function (quake) {
            ...
            var tarihObj = new Date(quake.OlusTarihi);
            var tarih = tarihObj.toISOString().split('T')[0];
            var saat = quake.OlusZamani ? quake.OlusZamani.split('T')[1].split('.')[0] : '';
            var circle = L.circle([lat, lng], {
              color: getQuakeColor(magnitude),
              fillColor: getQuakeColor(magnitude),
              fillOpacity: 0.35,
            ...
            circle.bindPopup("\n                <div class=\"popup-content\">\n                    <h3>Deprem Bilgileri</h3>\n                    <p><strong>B\xFCy\xFCkl\xFCk:</strong> ".concat(magnitude, "</p>\n                    <p><strong>Tarih:</strong> ").concat(tarih, "</p>\n                    <p><strong>Saat:</strong> ").concat(saat, "</p>\n                    <p><strong>Derinlik:</strong> ").concat(quake.Derinlik, " km</p>\n                    <p><strong>Yer:</strong> ").concat(quake.Yer || 'Bilinmiyor', "</p>\n                </div>\n            "));
          });
          _context2.next = 16;
          break;
        case 13:
          ...
          console.error("".concat(year, " deprem verileri y\xFCklenirken hata:"), _context2.t0);
        case 16:
        case "end":
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../src/scripts/map.js"], null)
//# sourceMappingURL=/map.f0cfd6df.js.map